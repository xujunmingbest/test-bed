...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->listView1->Location = System::Drawing::Point(42, 143);
			this->listView1->Name = L"listView1";
			this->listView1->Size = System::Drawing::Size(953, 584);
			...
			this->label39->Font = (gcnew System::Drawing::Font(L"宋体", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->label39->Location = System::Drawing::Point(330, 738);
			...
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(1135, 772);
			...
			this->Load += gcnew System::EventHandler(this, &基尔霍夫定律实验设备::基尔霍夫定律实验设备_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void 基尔霍夫定律实验设备_Load(System::Object^  sender, System::EventArgs^  e) {
		...
		listView1->Items[1]->SubItems->Add("");
		listView1->Items[1]->SubItems->Add("CL04(智能电参数)*");

		listView1->Items->Add("3");
		listView1->Items[2]->SubItems->Add("");
		listView1->Items[2]->SubItems->Add("");
		listView1->Items[2]->SubItems->Add("数字万用表");
		...
		listView1->Items[5]->SubItems->Add("基尔霍夫定理");
		listView1->Items[5]->SubItems->Add("");
		listView1->Items[5]->SubItems->Add("DG01");

		listView1->Items->Add("7");
		listView1->Items[6]->SubItems->Add("实验导线");
		listView1->Items[6]->SubItems->Add("4mm");
		listView1->Items[6]->SubItems->Add("安全型");

		listView1->Items->Add("8");
		listView1->Items[7]->SubItems->Add("");
		listView1->Items[7]->SubItems->Add("");
		listView1->Items[7]->SubItems->Add("电流检测线");
