...
namespace 电工电路试验台 {
	...
	/// RC网络的频率特性实验器件 摘要
	/// </summary>
	public ref class RC网络的频率特性实验器件 : public System::Windows::Forms::Form
	{
	public:
		RC网络的频率特性实验器件(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->listView1->Location = System::Drawing::Point(53, 149);
			...
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(1292, 769);
			this->Controls->Add(this->listView1);
			this->FormBorderStyle = System::Windows::Forms::FormBorderStyle::None;
			this->Name = L"RC网络的频率特性实验器件";
			this->Text = L"RC网络的频率特性实验器件";
			this->Load += gcnew System::EventHandler(this, &RC网络的频率特性实验器件::RC网络的频率特性实验器件_Load);
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void RC网络的频率特性实验器件_Load(System::Object^  sender, System::EventArgs^  e) {
		...
		listView1->Items[4]->SubItems->Add("双踪示波器");
		listView1->Items[4]->SubItems->Add("");
		listView1->Items[4]->SubItems->Add("");

		listView1->Items->Add("6");
		listView1->Items[5]->SubItems->Add("RC网络的频率特性");
