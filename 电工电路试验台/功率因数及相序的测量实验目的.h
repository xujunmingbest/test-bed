...
namespace 电工电路试验台 {
	...
	/// 功率因数及相序的测量实验目的 摘要
	/// </summary>
	public ref class 功率因数及相序的测量实验目的 : public System::Windows::Forms::Form
	{
	public:
		功率因数及相序的测量实验目的(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Text = L"功率因数及相序的测量 实验目的";
			// 
			// label1
			// 
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"宋体", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->label1->Location = System::Drawing::Point(31, 363);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(1001, 37);
			this->label1->TabIndex = 20;
			this->label1->Text = L"    2.熟悉功率因数表的使用方法，了解负载性质对功率因数的影响。";
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"宋体", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->label2->Location = System::Drawing::Point(31, 304);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(1001, 37);
			this->label2->TabIndex = 19;
			this->label2->Text = L"    1．掌握三相交流电路相序的测量方法。";
			// 
			// 功率因数及相序的测量实验目的
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 15);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(1130, 596);
			this->Controls->Add(this->label3);
			this->Controls->Add(this->label1);
			this->Controls->Add(this->label2);
			this->FormBorderStyle = System::Windows::Forms::FormBorderStyle::None;
			this->Name = L"功率因数及相序的测量实验目的";
			this->Text = L"功率因数及相序的测量实验目的";
