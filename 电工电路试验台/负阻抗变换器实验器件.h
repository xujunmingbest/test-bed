...
namespace 电工电路试验台 {
	...
	/// 负阻抗变换器实验器件 摘要
	/// </summary>
	public ref class 负阻抗变换器实验器件 : public System::Windows::Forms::Form
	{
	public:
		负阻抗变换器实验器件(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Name = L"负阻抗变换器实验器件";
			this->Text = L"负阻抗变换器实验器件";
			this->Load += gcnew System::EventHandler(this, &负阻抗变换器实验器件::负阻抗变换器实验器件_Load);
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void 负阻抗变换器实验器件_Load(System::Object^  sender, System::EventArgs^  e) {
