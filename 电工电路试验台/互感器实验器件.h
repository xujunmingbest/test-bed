...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->listView1->Location = System::Drawing::Point(33, 156);
			...
			this->ClientSize = System::Drawing::Size(1138, 753);
