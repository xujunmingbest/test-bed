...
namespace 电工电路试验台 {
	...
	/// <summary>
	/// 三相交流电路电压电流的测量实验目的 摘要
	/// </summary>
	public ref class 三相交流电路电压电流的测量实验目的 : public System::Windows::Forms::Form
	{
	public:
		三相交流电路电压电流的测量实验目的(void)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"    2．充分理解三相四线供电系统中中线的作用。";
			// 
			// label2
			// 
			...
			this->Name = L"三相交流电路电压电流的测量实验目的";
			this->Text = L"三相交流电路电压电流的测量实验目的";
