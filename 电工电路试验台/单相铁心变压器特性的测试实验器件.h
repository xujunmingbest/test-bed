...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->listView1->Location = System::Drawing::Point(73, 64);
...
#pragma endregion
	private: System::Void 单相铁心变压器特性的测试实验器件_Load(System::Object^  sender, System::EventArgs^  e) {
		...
		listView1->Items[2]->SubItems->Add("试验变压器");
		...
		listView1->Items[4]->SubItems->Add("总电源控制箱");
		listView1->Items[4]->SubItems->Add("含三相调压器");
		listView1->Items[4]->SubItems->Add("DY01");
