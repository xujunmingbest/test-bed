...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Load += gcnew System::EventHandler(this, &二阶动态电路响应的研究实验器件::二阶动态电路响应的研究实验器件_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void 二阶动态电路响应的研究实验器件_Load(System::Object^  sender, System::EventArgs^  e) {
		...
		listView1->Items[2]->SubItems->Add("双踪示波器");
		listView1->Items[2]->SubItems->Add("");
		listView1->Items[2]->SubItems->Add("选配");

		listView1->Items->Add("4");
		listView1->Items[3]->SubItems->Add("一阶/二阶动态电路");
