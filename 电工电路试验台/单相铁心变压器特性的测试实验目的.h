...
namespace 电工电路试验台 {
	...
	/// 单相铁心变压器特性的测试实验目的 摘要
	/// </summary>
	public ref class 单相铁心变压器特性的测试实验目的 : public System::Windows::Forms::Form
	{
	public:
		单相铁心变压器特性的测试实验目的(void)
		{
			InitializeComponent();
			//
			//TODO:  在此处添加构造函数代码
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"    2．学会测绘变压器的空载特性与外特性。";
			// 
			// label2
			// 
			...
			this->label2->Text = L"    1．通过测量，计算变压器的各项参数。";
			// 
			// 单相铁心变压器特性的测试实验目的
			// 
			...
			this->Name = L"单相铁心变压器特性的测试实验目的";
			this->Text = L"单相铁心变压器特性的测试实验目的";
