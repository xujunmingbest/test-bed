...
namespace 电工电路试验台 {
	...
	/// <summary>
	/// 基本电工仪表的使用与测量误差的计算实验器件 摘要
	/// </summary>
	public ref class 基本电工仪表的使用与测量误差的计算实验器件 : public System::Windows::Forms::Form
	{
	public:
		基本电工仪表的使用与测量误差的计算实验器件(void)
		{
			InitializeComponent();
			//
			//TODO:  在此处添加构造函数代码
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Name = L"基本电工仪表的使用与测量误差的计算实验器件";
			this->Text = L"基本电工仪表的使用与测量误差的计算实验器件";
			this->Load += gcnew System::EventHandler(this, &基本电工仪表的使用与测量误差的计算实验器件::基本电工仪表的使用与测量误差的计算实验器件_Load);
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void 基本电工仪表的使用与测量误差的计算实验器件_Load(System::Object^  sender, System::EventArgs^  e) {
		listView1->Items->Add("1");
		listView1->Items[0]->SubItems->Add("可调稳压源");
		listView1->Items[0]->SubItems->Add("0~30V");
		listView1->Items[0]->SubItems->Add("DY03（普通型）");

		listView1->Items->Add("2");
		listView1->Items[1]->SubItems->Add("");
		listView1->Items[1]->SubItems->Add("");
		listView1->Items[1]->SubItems->Add("DY07（数控型）");

		listView1->Items->Add("3");
		listView1->Items[2]->SubItems->Add("可变电阻箱");
		listView1->Items[2]->SubItems->Add("");
		listView1->Items[2]->SubItems->Add("DG04");

		listView1->Items->Add("4");
		listView1->Items[3]->SubItems->Add("电位器");
		listView1->Items[3]->SubItems->Add("");
		listView1->Items[3]->SubItems->Add("DG04");

		listView1->Items->Add("5");
		listView1->Items[4]->SubItems->Add("基本表");
		listView1->Items[4]->SubItems->Add("5mA");
		listView1->Items[4]->SubItems->Add("DG05");

		listView1->Items->Add("6");
		listView1->Items[5]->SubItems->Add("基本表");
