...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label39->Location = System::Drawing::Point(323, 764);
			...
			this->listView1->Location = System::Drawing::Point(50, 32);
			...
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(1539, 926);
			...
			this->Load += gcnew System::EventHandler(this, &戴维南定理实验器件::戴维南定理实验器件_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void 戴维南定理实验器件_Load(System::Object^  sender, System::EventArgs^  e) {
		...
		listView1->Items[6]->SubItems->Add("戴维南定理");
