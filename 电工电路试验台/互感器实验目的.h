...
namespace 电工电路试验台 {
	...
	/// 互感器实验目的 摘要
	/// </summary>
	public ref class 互感器实验目的 : public System::Windows::Forms::Form
	{
	public:
		互感器实验目的(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"宋体", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->label1->Location = System::Drawing::Point(12, 400);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(1001, 37);
			this->label1->TabIndex = 20;
			this->label1->Text = L"    2、学习电压互感器和电流互感器的使用方法。";
			// 
			// label2
			// 
			...
			this->label2->Text = L"    1、研究磁感应现象。 ";
			// 
			// 互感器实验目的
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 15);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(1247, 675);
