...
namespace 电工电路试验台 {
	...
	/// RC网络的频率特性实验目的 摘要
	/// </summary>
	public ref class RC网络的频率特性实验目的 : public System::Windows::Forms::Form
	{
	public:
		RC网络的频率特性实验目的(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Text = L"RC网络的频率特性 实验目的";
			// 
			// label1
			// 
			...
			this->label1->Text = L"    2．学会用万用表和示波器测定文氏电桥电路的幅频特性和相频特性。";
			// 
			// label2
			// 
			...
			this->label2->Text = L"    1．熟悉文氏电桥电路的结构特点及其应用。";
			// 
			// RC网络的频率特性实验目的
			// 
			...
			this->Name = L"RC网络的频率特性实验目的";
			this->Text = L"RC网络的频率特性实验目的";
			this->Load += gcnew System::EventHandler(this, &RC网络的频率特性实验目的::RC网络的频率特性实验目的_Load);
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void RC网络的频率特性实验目的_Load(System::Object^  sender, System::EventArgs^  e) {
	}
	};
}
