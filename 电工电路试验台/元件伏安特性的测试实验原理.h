...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Size = System::Drawing::Size(737, 68);
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"宋体", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->label6->Location = System::Drawing::Point(51, 832);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(699, 108);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"宋体", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->label3->Location = System::Drawing::Point(51, 244);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(699, 43);
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"宋体", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->label5->Location = System::Drawing::Point(51, 610);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(699, 110);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"宋体", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->label4->Location = System::Drawing::Point(51, 404);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(699, 91);
			...
			this->pictureBox1->Location = System::Drawing::Point(890, 293);
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"宋体", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->label7->Location = System::Drawing::Point(51, 207);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(198, 20);
			this->label7->TabIndex = 13;
			this->label7->Text = L"线性电阻器实验原理";
			// 
			// label8
			// 
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"宋体", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->label8->Location = System::Drawing::Point(51, 371);
			this->label8->Name = L"label8";
			this->label8->Size = System::Drawing::Size(240, 20);
			this->label8->TabIndex = 14;
			this->label8->Text = L"非线性白炽灯泡实验原理";
			// 
			// label9
			// 
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"宋体", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->label9->Location = System::Drawing::Point(51, 576);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(219, 20);
			this->label9->TabIndex = 15;
			this->label9->Text = L"半导体二极管实验原理";
			// 
			// label10
			// 
			...
			this->label10->Font = (gcnew System::Drawing::Font(L"宋体", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(134)));
			this->label10->Location = System::Drawing::Point(51, 801);
			this->label10->Name = L"label10";
			this->label10->Size = System::Drawing::Size(198, 20);
			this->label10->TabIndex = 16;
			this->label10->Text = L"稳压二极管实验原理";
			// 
			// 元件伏安特性的测试实验原理
			// 
			...
			this->ClientSize = System::Drawing::Size(1529, 1056);
