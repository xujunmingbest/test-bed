...
namespace 电工电路试验台 {
	...
	/// 单相电度表实验实验器件 摘要
	/// </summary>
	public ref class 单相电度表实验实验器件 : public System::Windows::Forms::Form
	{
	public:
		单相电度表实验实验器件(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(1192, 657);
			this->Controls->Add(this->listView1);
			this->FormBorderStyle = System::Windows::Forms::FormBorderStyle::None;
			this->Name = L"单相电度表实验实验器件";
			this->Text = L"单相电度表实验实验器件";
			this->Load += gcnew System::EventHandler(this, &单相电度表实验实验器件::单相电度表实验实验器件_Load);
