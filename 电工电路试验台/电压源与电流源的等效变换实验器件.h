...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Load += gcnew System::EventHandler(this, &电压源与电流源的等效变换实验器件::电压源与电流源的等效变换实验器件_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void 电压源与电流源的等效变换实验器件_Load(System::Object^  sender, System::EventArgs^  e) {
		...
		listView1->Items[7]->SubItems->Add("电压源/电流源等效变换");
