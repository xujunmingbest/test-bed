...
namespace 电工电路试验台 {
	...
	/// 二端口网络的研究实验器件 摘要
	/// </summary>
	public ref class 二端口网络的研究实验器件 : public System::Windows::Forms::Form
	{
	public:
		二端口网络的研究实验器件(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Location = System::Drawing::Point(72, 262);
			...
			this->label17->Size = System::Drawing::Size(110, 24);
			this->label17->TabIndex = 21;
			this->label17->Text = L"双口网络";
			// 
			// label18
			// 
			...
			this->label4->Click += gcnew System::EventHandler(this, &二端口网络的研究实验器件::label4_Click);
			// 
			// label3
			// 
			...
			this->Name = L"二端口网络的研究实验器件";
			this->Text = L"二端口网络的研究实验器件";
			this->Load += gcnew System::EventHandler(this, &二端口网络的研究实验器件::二端口网络的研究实验器件_Load);
...
private: System::Void 二端口网络的研究实验器件_Load(System::Object^  sender, System::EventArgs^  e) {
}
};
}
